...
<div class="notice--danger">
  해당 글의 내용은 <span style="color:red;">객체 지향 프로그래밍</span>에서 쉽게 가질 수 있는 <b>잘못된 개념과 오해</b>들에 대해 <span style="color:blue;">객체지향의 사실과 오해</span>와 <span style="color:blue;">클린 소프트웨어</span>라는 책의 내용과 더불어 내 생각을 덧붙여 정리한 것이다. (아직 작성 중이다..)
</div>
